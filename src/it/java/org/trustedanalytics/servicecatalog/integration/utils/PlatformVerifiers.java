 ...
 */
package org.trustedanalytics.servicecatalog.integration.utils;
...
public class PlatformVerifiers {
    ...
    public static void verifySetTokenThenPut(RestOperations restTemplate, String token,
        String url, Object request, Map<String, ?> vars) {

        InOrder verifier = verifyTokenWasSet(restTemplate, token);
        verifier.verify(restTemplate).put(url, request, vars);
    }
